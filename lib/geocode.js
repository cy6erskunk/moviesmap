/* eslint-env node, es6 */
let defaultMapsClient = require('@google/maps').createClient({
    key: process.env.MAPS_KEY
});

function geocodeAddress(address, {mapsClient = defaultMapsClient, responseProcessor = defaultResponseProcessor} = {}) {
 ...
 */
module.exports = (input, optionsObject) => {
    return geocodeAddress(input, optionsObject);
};